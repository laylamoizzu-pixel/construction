                            ...
                            <AnimatePresence mode="wait">
                                {isSuccess ? (
                                    ...
                                    >
                                        ...
                                        <h3 className="text-2xl font-bold text-gray-900 mb-2">Property Request Sent!</h3>
                                        <p className="text-gray-500 max-w-xs mx-auto text-base">
                                            Your request is our priority. We&apos;ll notify you as soon as we find the right property for you.
                                        </p>
                                    </motion.div>
                                ) : (
                                    <motion.form
